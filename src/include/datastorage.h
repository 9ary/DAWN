...
struct probe_metric_s {
    ...
    int rcpi[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int low_rcpi[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int rsni[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int low_rsni[__DAWN_BAND_MAX]; // eval_probe_metric()()
    ...
    int rcpi_val[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int low_rcpi_val[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int rsni_val[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int low_rsni_val[__DAWN_BAND_MAX]; // eval_probe_metric()()
    ...
    int rcpi_weight[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int rcpi_center[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int rsni_weight[__DAWN_BAND_MAX]; // eval_probe_metric()()
    int rsni_center[__DAWN_BAND_MAX]; // eval_probe_metric()()
